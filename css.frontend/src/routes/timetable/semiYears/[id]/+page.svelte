<script lang="ts">
    ...
    import { getFacultyGroup, getFacultyGroupOrNull } from '../../../../stores/facultyGroups';
    import { getRoom, type Room } from '../../../../stores/rooms';
    import { scheduleStore, type Schedule } from "../../../../stores/schedule";
    import { getSemiYear, getSemiYearOrNull, type SemiYear } from '../../../../stores/semiYears';
    import { getTeacher, type Teacher } from '../../../../stores/teacher';
    import { refreshAllStores } from '../../../../stores/entity';
    
    let semiYear: SemiYear = $derived(getSemiYear(page.params.id));

    let list: Schedule[] = $derived($scheduleStore
            .filter(s => (s.studentsId == semiYear.id || getFacultyGroupOrNull(s.studentsId)?.semiYearId == semiYear.id)));
</script>
